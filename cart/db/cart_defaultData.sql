...
VALUES
(1, '4941 4th Street', '', '', 'Zephyrhills', '33542', 'FL', 'USA', 'Franchise Headquarters');

-- Store
INSERT INTO `stores`
(storeID, storeName, storeActive, storeNotes, storeTheme, addressID, storePhone, emailOrders, emailContact, emailErrors)
VALUES
(1, 'Goin&#39; Postal Franchise Corporation', 1, '', 'default', 1, '813-782-1500', 'brock@goinpostal.com', 'brock@goinpostal.com', 'brock@goinpostal.com');
...
(storeID, gatewayID, gatewayActive)
VALUES
(1, 1, 0),
(1, 2, 1);
