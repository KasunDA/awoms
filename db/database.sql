...
-- Table `aclDefaults`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `aclDefaults` ;

CREATE TABLE IF NOT EXISTS `aclDefaults` (
  `brandID` BIGINT(20) UNSIGNED NOT NULL,
  `usergroupID` BIGINT UNSIGNED NOT NULL,
  ...
  PRIMARY KEY (`brandID`, `usergroupID`, `controller`),
  INDEX `fk_aclDefaults_usergroups1_idx` (`usergroupID` ASC),
  INDEX `fk_aclDefaults_users1_idx` (`userID` ASC),
  CONSTRAINT `fk_aclDefaults_brands1`
    FOREIGN KEY (`brandID`)
    REFERENCES `brands` (`brandID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aclDefaults_usergroups1`
    FOREIGN KEY (`usergroupID`)
    REFERENCES `usergroups` (`usergroupID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_aclDefaults_users1`
    FOREIGN KEY (`userID`)
    REFERENCES `users` (`userID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
