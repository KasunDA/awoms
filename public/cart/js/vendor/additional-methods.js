 ...
 *
 * partnumber:  {require_fromGroup: [1,".productinfo"]},
 * description: {require_fromGroup: [1,".productinfo"]}
 *
 */
jQuery.validator.addMethod("require_fromGroup", function(value, element, options) {
    var validator = this;
