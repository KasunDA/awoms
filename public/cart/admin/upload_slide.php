...
?>
<div id="uploadModal" class="modal hide fade" style="width:60%; margin-left:-30%; height:80%;" tabindex="-1" role="dialog" aria-labelledby="uploadModalLbl" aria-hidden="true">
    ...
    <div id='uploadModalBody' class="modal-body" style="max-height: 80%;">

      <!-- Select Existing Image -->
<?php
$image = new killerCart\Image();
$is = $image->getCartImages( $cartID );
foreach ($is as $i)
{
  $bi = $image->getBestFitImage( $cartID, $i['imageID'], $i['imageWidth'], $i['imageHeight'], '128', '128');
?>
  <img class="img-polaroid chosenSlideImage existingImageID<?php echo $i['imageID']; ?>" data-src="holder.js/128x128" alt="" src="/getfile.php?cartID=1&amp;imageID=<?php echo $i['imageID']; ?>&amp;w=<?php echo $bi['bestWidth']; ?>&amp;h=<?php echo $bi['bestHeight']; ?>">
<?php
}
?>
