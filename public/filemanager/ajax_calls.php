...
if (isset($_GET['action']))
{
    switch ($_GET['action'])
    {
        ...
        case 'save_img':
            ...
            new_thumbnails_creation($current_path . $_POST['path'], $current_path . $_POST['path'] . $_POST['name'], $_POST['name'],
                                    $current_path, $relative_image_creation, $relative_path_from_current_pos,
        ...
        case 'copy_cut':
            ...
            if (is_dir($path))
            {
                ...
                {
                    die(sprintf(lang_Copy_Cut_Not_Allowed, ($_POST['sub_action'] == 'copy' ? lcfirst(lang_Copy) : lcfirst(lang_Cut)),
                                                                                                                          lang_Folders));
                }
                ...
                if ($copy_cut_max_size !== FALSE && is_int($copy_cut_max_size))
                {
                    ...
                    {
                        die(sprintf(lang_Copy_Cut_Size_Limit,
                                    ($_POST['sub_action'] == 'copy' ? lcfirst(lang_Copy) : lcfirst(lang_Cut)), $copy_cut_max_size));
                    }
                }
                ...
                if ($copy_cut_max_count !== FALSE && is_int($copy_cut_max_count))
                {
                    ...
                    {
                        die(sprintf(lang_Copy_Cut_Count_Limit,
                                    ($_POST['sub_action'] == 'copy' ? lcfirst(lang_Copy) : lcfirst(lang_Cut)), $copy_cut_max_count));
                    }
                }
            }
            else
