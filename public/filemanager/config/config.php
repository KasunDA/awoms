...
$upload_dir       = '/file/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path     = '../file/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../file/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
// OPTIONAL SECURITY
...
$fixed_path_from_filemanager             = array('../file/thumbs/', '../file/thumbs/', '../file/thumbs/', '../file/thumbs/'); //fixed path of the image folder from the current position on upload folder
$fixed_image_creation_name_to_prepend    = array('', '', '', ''); //name to prepend on filename
$fixed_image_creation_to_append          = array('_thumb_64', '_thumb_128', '_thumb_256', '_thumb_512'); //name to appendon filename
$fixed_image_creation_width              = array(64, 128, 256, 512); //width of image (you can leave empty if you set height)
